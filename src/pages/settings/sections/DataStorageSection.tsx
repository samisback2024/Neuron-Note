...
export function DataStorageSection() {
  ...
  /* â”€â”€ Approximate storage usage â”€â”€ */
        ...
        <div className="mb-5 pb-5 border-b border-zinc-100 dark:border-zinc-800">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {storageInfo.items.map((item) => (
              <div
                key={item.label}
                className="p-3 bg-zinc-50 dark:bg-zinc-800/30 rounded-xl text-center"
              >
        ...
        <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
          ...
          >
            <button
              ...
              className="px-3 py-1.5 text-sm font-medium text-zinc-700 dark:text-zinc-300 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-lg transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
            >
              Clear
            </button>
          </SettingRow>
          ...
          >
            <span className="text-sm text-zinc-500 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-800 px-3 py-1 rounded-lg">
              30 days
            </span>
          </SettingRow>
        </div>
          ...
          <div className="relative bg-white dark:bg-zinc-800 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 w-full max-w-md p-6">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 text-zinc-900 dark:text-white focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500/20"
              />
            </div>
