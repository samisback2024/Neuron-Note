...
export function TasksPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-6">
      ...
      <p className="text-[12.5px] text-zinc-500 dark:text-zinc-400 mb-6">
        {remaining} tasks remaining
      </p>

      {/* Filters */}
      <div className="flex items-center gap-1.5 mb-6">
        <Filter size={14} className="text-zinc-400 mr-1.5" />
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-[12.5px] font-medium transition-colors capitalize ${
                filter === f
                  ...
                  : "bg-zinc-100 dark:bg-zinc-900/70 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-800/60"
              }`}
            >
              {f}
            </button>
      ...
      <AnimatePresence>
        {showNewTask && (
          ...
          >
            <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 border border-primary-200 dark:border-primary-700 space-y-3">
              ...
              <input
                ...
                autoFocus
                className="w-full px-3 py-2.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30"
              ...
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="text-sm rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white px-2 py-1.5 focus:outline-none"
                  >
        ...
        {filteredTasks.length === 0 ? (
          ...
          filteredTasks.map((task, i) => (
            <motion.div
              ...
              className="group bg-white dark:bg-zinc-900/70 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm card-hover flex items-center gap-4"
            >
              <button
                onClick={() =>
              ...
              >
                {task.completed ? (
                  ...
                  <Circle
                    size={22}
                    className="text-zinc-300 dark:text-zinc-600 hover:text-primary-400 transition-colors"
                  />
                )}
              </button>
              ...
              <button
                ...
                className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 text-zinc-400 hover:text-red-500 transition-all flex-shrink-0"
              >
                <Trash2 size={14} />
              </button>
            </motion.div>
      ...
      {tasks.length > 0 && (
        ...
        >
          {[
            ...
            <div
              key={stat.label}
              className="bg-white dark:bg-zinc-900/70 rounded-2xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm text-center"
            >
              <p className="text-[20px] font-semibold text-zinc-900 dark:text-zinc-50">
                {stat.value}
              </p>
