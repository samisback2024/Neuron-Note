    ...
    <div className="p-6 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3 rounded-xl border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 text-surface-900 dark:text-white placeholder-surface-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 text-sm transition-all"
        />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredNotes.map((note, i) => (
            <motion.div
              ...
              className="group bg-white dark:bg-surface-800 rounded-2xl p-5 border border-surface-200 dark:border-surface-700/50 hover:shadow-lg hover:border-primary-200 dark:hover:border-primary-700 transition-all cursor-pointer"
            >
              <h3 className="font-semibold text-surface-900 dark:text-white text-sm mb-2 truncate">
                {note.title || "Untitled"}
              </h3>
              <p className="text-xs text-surface-500 line-clamp-4 leading-relaxed mb-4">
