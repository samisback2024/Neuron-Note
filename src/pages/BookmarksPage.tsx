        ...
        <div className="space-y-3">
          {filtered.map((bookmark, i) => (
            <motion.div
              ...
              className="group bg-white dark:bg-surface-800 rounded-xl p-4 border border-surface-200 dark:border-surface-700/50 hover:shadow-md transition-all flex items-start gap-4"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filtered.map((bookmark, i) => (
            <motion.div
              ...
              transition={{ delay: i * 0.03 }}
              className="group bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700/50 hover:shadow-lg transition-all overflow-hidden"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {collections.map((col, i) => {
              ...
              return (
                <div
                  key={col}
                  className="bg-white dark:bg-surface-800 rounded-xl p-5 border border-surface-200 dark:border-surface-700/50 hover:shadow-md transition-all cursor-pointer"
                >
                  <div
